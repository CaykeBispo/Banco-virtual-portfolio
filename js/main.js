...
jQuery(document).ready(function( $ ){
	...
	// ----------------- Banner Abertura de Conta  -------------------------------
		...
		$.getJSON('js/main-menu.json', function(data){
			...
			function parseData(data) {
				...
				link.setAttribute('onclick', "trackBancoVirtual('Portal Classic','Menu - Lateral','"+data.NomeArea+"');");
				...
				if (data.UrlArea == '/html/classic/produtos-servicos/emprestimo-e-financiamento/imoveis/credito-imobiliario-aquisicao-de-imoveis.shtm') {
					link.setAttribute('onclick', "trackBancoVirtual('Classic','Emprestimos Financimento Imoveis Home','Menu Lateral_credito-imobiliario-aquisicao-de-imoveis');");
					...
					link.setAttribute('onclick', "trackBancoVirtual('Classic','Emprestimos Financimento Imoveis Home','Menu Lateral_credito-imobiliario-construcao');");
					...
					link.setAttribute('onclick', "trackBancoVirtual('Classic','Emprestimos Financimento Imoveis Home','Menu Lateral_credito-imobiliario-aquisicao-de-lote-urbano');");
				} else if (data.UrlArea == '/html/classic/produtos-servicos/emprestimo-e-financiamento/imoveis/cdc-despesas-cartorarias.shtm') {
					link.setAttribute('onclick', "trackBancoVirtual('Classic','Emprestimos Financimento Imoveis Home','Menu Lateral_cdc-despesas-cartorarias');");
				} else if (data.UrlArea == '/html/classic/produtos-servicos/emprestimo-e-financiamento/imoveis/cdc-material-de-construcao.shtm') {
					link.setAttribute('onclick', "trackBancoVirtual('Classic','Emprestimos Financimento Imoveis Home','Menu Lateral_cdc-material-de-construcao');");
					...
					link.setAttribute('onclick', "trackBancoVirtual('Classic','Emprestimos Financimento Imoveis Home','Menu Lateral_cdc-reforma-condominios-e-reuso-de-agua');");
				} else if (data.UrlArea == '/html/classic/produtos-servicos/emprestimo-e-financiamento/imoveis/cdc-aquecedores-solares.shtm') {
					link.setAttribute('onclick', "trackBancoVirtual('Classic','Emprestimos Financimento Imoveis Home','Menu Lateral_cdc-aquecedores-solares');");
				} else if (data.UrlArea == '/html/classic/produtos-servicos/emprestimo-e-financiamento/imoveis/cdc-moveis-planejados.shtm') {
					link.setAttribute('onclick', "trackBancoVirtual('Classic','Emprestimos Financimento Imoveis Home','Menu Lateral_cdc-moveis-planejados');");
				} else if (data.UrlArea == '/html/classic/produtos-servicos/emprestimo-e-financiamento/imoveis/fianca-de-aluguel.shtm') {
					link.setAttribute('onclick', "trackBancoVirtual('Classic','Emprestimos Financimento Imoveis Home','Menu Lateral_fianca-de-aluguel);");
				...
				// Menu Lateral
					...
					link.setAttribute('onclick', "trackBancoVirtual('Portal Classic - Home','Menu Lateral','Produtos e Serviços');");
				}
				else if (data.UrlArea == '/html/classic/promocoes/index.shtm') {
					link.setAttribute('onclick', "trackBancoVirtual('Portal Classic - Home','Menu - Produtos e serviços','Promoções e Campanhas');");
				}
				else if (data.UrlArea == '/html/classic/acessibilidade/index.shtm') {
					link.setAttribute('onclick', "trackBancoVirtual('Portal Classic - Home','Menu Lateral','Acessibilidade');");
				}
				else if (data.UrlArea == '/html/classic/sobre/index.shtm') {
					link.setAttribute('onclick', "trackBancoVirtual('Portal Classic - Home','Menu Lateral','Sobre o Bradesco');");
				}
				else if (data.UrlArea == '/html/classic/educacao-financeira/index.shtm') {
					link.setAttribute('onclick', "trackBancoVirtual('Portal Classic - Home','Menu Lateral','Educação Financeira');");
				}
				else if (data.UrlArea == '/html/classic/canais-digitais/index.shtm') {
					link.setAttribute('onclick', "trackBancoVirtual('Portal Classic - Home','Menu Lateral','Canais Digitais');");
				}
				else if (data.UrlArea == '/html/classic/atendimento/atendimento.shtm') {
					link.setAttribute('onclick', "trackBancoVirtual('Portal Classic - Home','Menu Lateral','Atendimento');");
				}
				// End Menu Lateral
				else if (data.UrlArea == "https://banco.bradesco/soliciteseucartao?OrigeVda=913&PtoVda=001&TpoPto=3&Campa=913") {
					link.setAttribute('onclick', "trackBancoVirtual('Classic','Menu_Esq','Peca_seu_cartao');");
				} else if (data.UrlArea == "/html/classic/produtos-servicos/cartoes/index.shtm") {
					link.setAttribute('onclick', "trackBancoVirtual('Classic','Menu_Esq','Cartoes);");
				} else if (data.UrlArea == "/html/classic/produtos-servicos/cartoes/conheca-os-cartoes/index.shtm") {
					link.setAttribute('onclick', "trackBancoVirtual('Classic','Menu_Esq','Conheca_os_cartoes');");
				} else if (data.UrlArea == "/html/classic/produtos-servicos/cartoes/meu-cartao/escolha-seu-cartao.shtm") {
					link.setAttribute('onclick', "trackBancoVirtual('Classic','Menu_Esq','Guia_digital');");
				} else if (data.UrlArea == "/html/classic/produtos-servicos/cartoes/servicos/index.shtm") {
					link.setAttribute('onclick', "trackBancoVirtual('Classic','Menu_Esq','Servicos');");
				} else if (data.UrlArea == "https://banco.bradesco/cartoes/ofertasebeneficios") {
					link.setAttribute('onclick', "trackBancoVirtual('Classic','Menu_Esq','Beneficios_ofertas');");
				} else if (data.UrlArea == "/html/classic/produtos-servicos/cartoes/bradesco-cartoes/index.shtm") {
					link.setAttribute('onclick', "trackBancoVirtual('Classic','Menu_Esq','app_cartoes');");
				} else if (data.UrlArea == "/html/classic/produtos-servicos/cartoes/pagamentos-digitais.shtm") {
					link.setAttribute('onclick', "trackBancoVirtual('Classic','Menu_Esq','Pagamentos_digitais');");
				} else if (data.UrlArea == '/html/classic/produtos-servicos/renegociacao-de-dividas/index.shtm') {
					if ($.ua.device.type != 'mobile')
						link.setAttribute('onclick', "trackBancoVirtual('Portal_Classic','Renegociação_de_dívidas','Menu_Renegociação_de_dívidas');");
					else
						link.setAttribute('onclick', "trackBancoVirtual('Portal_Classic','Renegociação_de_dívidas','Menu_Renegociação_de_dívidas_Mobile');");
				} else if (data.UrlArea == '/html/classic/produtos-servicos/renegociacao-de-dividas/canais-de-renegociacao.shtm') {
					if ($.ua.device.type != 'mobile')
						link.setAttribute('onclick', "trackBancoVirtual('Portal_Classic','Renegociação_de_dívidas','Menu_Canais_de_renegociação');");
					else
						link.setAttribute('onclick', "trackBancoVirtual('Portal_Classic','Renegociação_de_dívidas','Menu_Canais_de_renegociação_Mobile');");
				} else if (data.UrlArea == '/html/classic/produtos-servicos/renegociacao-de-dividas/index.shtm#pre-aprovada') {
					if ($.ua.device.type != 'mobile')
						link.setAttribute('onclick', "trackBancoVirtual('Portal_Classic','Renegociação_de_dívidas','Menu_Proposta_pré-aprovada');");
					else
						link.setAttribute('onclick', "trackBancoVirtual('Portal_Classic','Renegociação_de_dívidas','Menu_Proposta_pré-aprovada_Mobile-aprovada');");
				} else if (data.UrlArea == '/html/classic/produtos-servicos/renegociacao-de-dividas/faca-sua-proposta.shtm') {
					if ($.ua.device.type != 'mobile')
						link.setAttribute('onclick', "trackBancoVirtual('Portal_Classic','Renegociação_de_dívidas','Menu_Faça_uma_proposta');");
					else
						link.setAttribute('onclick', "trackBancoVirtual('Portal_Classic','Renegociação_de_dívidas','Menu_Faça_uma_proposta_Mobile');");
				} else if (data.UrlArea == '/html/classic/produtos-servicos/renegociacao-de-dividas/index.shtm#assessoria') {
					if ($.ua.device.type != 'mobile')
						link.setAttribute('onclick', "trackBancoVirtual('Portal_Classic','Renegociação_de_dívidas','Menu_Empresas_credenciadas');");
					else
						link.setAttribute('onclick', "trackBancoVirtual('Portal_Classic','Renegociação_de_dívidas','Menu_Empresas_credenciadas_Mobile');");
				}
		...
		function toggleMenuMobile(param){
			...
			/*$('<form name="FormNaoCorrentista" id="FormNaoCorrentista" method="post" onsubmit="return ValidaFormNaoCorrentista(this);" action=" https://www.ib12.banco-virtual.com.br/ibpfnaocorrentistalogin/identificacao.jsf">' +
				'&nbsp;&nbsp;&nbsp;&nbsp;' +
				...
				'&nbsp;' +
				'<input type="submit" value="OK" title="Entrar" tabindex="15" onclick="trackBancoVirtual("classic", "Cabecalho", "OKNaoCorrentista");">' +
				'<a href="/html/classic/produtos-servicos/cartoes/cliente-nao-correntista.shtm" onclick="trackBancoVirtual("Classic", "Cabecalho", "BotaoComoFunciona");" title="O acesso às informações do seu cartão mudou. Digite o CPF, clique em Primeiro acesso e faça seu recadastro.  Se você for um novo cliente, siga os mesmos passos." class="duvd"></a>' +
			...
			if ($('#mainMenu > h2 > ul > li > ul > li.cartoes').hasClass('active')) {
				...
				$('<div class="nao-correntista"><a href="#" onclick="abreClienteNCorrentista(\'https://www.ib12.banco-virtual.com.br/cartoes-banco-virtual/loginCartao.jsf\',\'750\',\'480\');">Cliente nÃ£o correntista</a></div>').insertBefore('div.mm-panels');
				$('#MainMenuMobile > div.mm-panels').css('top','96px');
	...
	$('.modalCartoesIB').magnificPopup({
		...
		$('.chosen-select-b1').chosen({ // Estiliza o combo do footer
			...
			trackBancoVirtual(''+segmento+'',''+area+'',''+produto+'');
		});
		...
		*/
		...
		$(".ed-fn .twitter").click(function() {
			var twiter = "https://twitter.com/?status=https://www.banco-virtual.com.br" + location.pathname;
			$(this).attr("href", twiter)
		});
		$(".ed-fn .facebook").click(function() {
			var facebook = "https://www.facebook.com/sharer/sharer.php?u=https://www.banco-virtual.com.br" + location.pathname;
	...
	function abreClienteNCorrentista(pagina, largura, altura){
		...
		trackBancoVirtual('Classic', 'Cartão - Cliente não conrretista', 'cliente_nao_correntista');
	}
	...
	function chatIB(){
		...
		trackBancoVirtual('Classic','Chat','Como_Usar_Chat_IB');
	}
	...
	$(window).on('load', function(){
		...
		$("#mainMenu > ul > li.produtos-servicos > ul > li.mais-produtos-servicos > ul > li.regularizacao-de-divida > a, #MainMenuMobile li.regularizacao-de-divida a:last-child").attr("onclick", "trackBancoVirtual('Classic','Menu Lado Esquerda','Mais Produtos e Servicos Regularizacao de Divida');");
	
		$("#mainMenu > ul > li.produtos-servicos > ul > li.mais-produtos-servicos > ul > li.regularizacao-de-divida > ul > li.canais-de-renegociacao > a, #MainMenuMobile li.canais-de-renegociacao a:last-child").attr("onclick", "trackBancoVirtual('Classic','Menu Lado Esquerda','Mais Produtos e Servicos Regularizacao de Divida Canais de Renegociacao');");
	
		$("#mainMenu > ul > li.produtos-servicos > ul > li.mais-produtos-servicos > ul > li.regularizacao-de-divida > ul > li.proposta-pre-aprovada > a, #MainMenuMobile li.proposta-pre-aprovada a:last-child").attr("onclick", "trackBancoVirtual('Classic','Menu Lado Esquerda','Mais Produtos e Servicos Regularizacao de Divida Proposta pre aprovada');");
	
		$("#mainMenu > ul > li.produtos-servicos > ul > li.mais-produtos-servicos > ul > li.regularizacao-de-divida > ul > li.faca-sua-proposta > a, #MainMenuMobile li.faca-sua-proposta a:last-child").attr("onclick", "trackBancoVirtual('Classic','Menu Lado Esquerda','Mais Produtos e Servicos Regularizacao de Divida Faca sua proposta');");
	
		$("#mainMenu > ul > li.produtos-servicos > ul > li.mais-produtos-servicos > ul > li.regularizacao-de-divida > ul > li.assessorias-parceiras > a, #MainMenuMobile li.assessorias-parceiras a:last-child").attr("onclick", "trackBancoVirtual('Classic','Menu Lado Esquerda','Mais Produtos e Servicos Regularizacao de Divida Assessorias Parceiras');");
